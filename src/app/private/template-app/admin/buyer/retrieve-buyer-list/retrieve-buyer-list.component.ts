...
import {
    retrieveBuyerListDataObject,
    retrieveBuyerListSearchFilter
} from 'src/app/shared/interfaces/dto/template-app/buyer/retrieve-buyer-list';
...
@Component({
selector: 'app-retrieve-buyer-list',
  templateUrl: './retrieve-buyer-list.component.html',
  styleUrls: ['./retrieve-buyer-list.component.scss']
...
export class RetrieveBuyerListComponent extends FormFieldsTemplateAppImplComponent implements OnInit
{
  pageComponentReference: any;
  userActions : Array<any> = [];
  retrieveBuyerListSectionFields: any = [];
  retrieveBuyerListSectionData: any = {};
  retrieveBuyerListSelectOptionsData: any = {};
  ...
  noOfPages: number = 0;
  searchFilter: retrieveBuyerListSearchFilter = <retrieveBuyerListSearchFilter>{};
  pageResultsMap: Map<number, retrieveBuyerListDataObject[]> = new Map<number, retrieveBuyerListDataObject[]>();
  pageSizeOptions = PAGE_SIZE_OPTIONS;
  

  
  yesNoOptions = YES_NO_OPTIONS;
  retrieveBuyerListTableColumns : Array<any> = [];
  ...
  async ngOnInit(): Promise<void> {
    ...
    this.userActions = this.getUserActionsCustom('RetrieveBuyerList');
    /**
    ...
    //Load table columns
    let retrieveBuyerListResponseParamList = await this.getApiResponseParameterListCustom('retrieveBuyerList', this.backendService, this.toastNotificationService);
    this.retrieveBuyerListTableColumns = this.getListApiTableColumnListCustom('retrieveBuyerList', retrieveBuyerListResponseParamList, this);
    //Load page fields
    let retrieveBuyerListRequestParamList = await this.getApiRequestParameterListCustom('retrieveBuyerList', this.backendService, this.toastNotificationService);
    this.retrieveBuyerListSectionFields = this.getSectionFieldsFromApiRequestParams('retrieveBuyerList', retrieveBuyerListRequestParamList, this);

    this.setDataToFormOnload("retrieveBuyerList", this.router, this.currentRoute, this);
    this.onPageInit("retrieveBuyerList", this.currentRoute, this, ["retrieveBuyerListSC"]);
  }

  async resetSearchCriteria() {
    this.retrieveBuyerListSectionData = {};
  }
  ...
  {
    this.pageResultsMap.clear();
    this.searchFilter.firstName = this.retrieveBuyerListSectionData['firstName'];
    this.searchFilter.lastName = this.retrieveBuyerListSectionData['lastName'];
  ...
  async handleBuyerListPageChange(): Promise<void>
  {
  ...
  async fetchBuyerList() {
    ...
    let searchResponse = <RetrieveListResponseModel>await this.backendService.retrieveBuyerList(this.searchFilter);
  ...
  {
    this.executeUserActionCustom(actionName, 'RetrieveBuyerList', this.router, dataObject, this.backendService, this.toastNotificationService);
  }
  ...
  {
    this.updateDependentFieldsDisplayProps(apiName, key,  selectedValue, this, ["retrieveBuyerListSC"]);
  }
