...
import {
    retrieveClassInfoListDataObject,
    retrieveClassInfoListSearchFilter
} from 'src/app/shared/interfaces/dto/template-app/class-info/retrieve-class-info-list';
...
@Component({
selector: 'app-retrieve-class-info-list',
  templateUrl: './retrieve-class-info-list.component.html',
  styleUrls: ['./retrieve-class-info-list.component.scss']
...
export class RetrieveClassInfoListComponent extends FormFieldsTemplateAppImplComponent implements OnInit
{
  pageComponentReference: any;
  userActions : Array<any> = [];
  retrieveClassInfoListSectionFields: any = [];
  retrieveClassInfoListSectionData: any = {};
  retrieveClassInfoListSelectOptionsData: any = {};
  ...
  noOfPages: number = 0;
  searchFilter: retrieveClassInfoListSearchFilter = <retrieveClassInfoListSearchFilter>{};
  pageResultsMap: Map<number, retrieveClassInfoListDataObject[]> = new Map<number, retrieveClassInfoListDataObject[]>();
  pageSizeOptions = PAGE_SIZE_OPTIONS;
  

  
  yesNoOptions = YES_NO_OPTIONS;
  retrieveClassInfoListTableColumns : Array<any> = [];
  ...
  async ngOnInit(): Promise<void> {
    ...
    this.userActions = this.getUserActionsCustom('RetrieveClassInfoList');
    /**
    ...
    //Load table columns
    let retrieveClassInfoListResponseParamList = await this.getApiResponseParameterListCustom('retrieveClassInfoList', this.backendService, this.toastNotificationService);
    this.retrieveClassInfoListTableColumns = this.getListApiTableColumnListCustom('retrieveClassInfoList', retrieveClassInfoListResponseParamList, this);
    //Load page fields
    let retrieveClassInfoListRequestParamList = await this.getApiRequestParameterListCustom('retrieveClassInfoList', this.backendService, this.toastNotificationService);
    this.retrieveClassInfoListSectionFields = this.getSectionFieldsFromApiRequestParams('retrieveClassInfoList', retrieveClassInfoListRequestParamList, this);

    this.setDataToFormOnload("retrieveClassInfoList", this.router, this.currentRoute, this);
    this.onPageInit("retrieveClassInfoList", this.currentRoute, this, ["retrieveClassInfoListSC"]);
  }

  async resetSearchCriteria() {
    this.retrieveClassInfoListSectionData = {};
  }
  ...
  {
    this.pageResultsMap.clear();
    this.searchFilter.name = this.retrieveClassInfoListSectionData['name'];
    this.searchFilter.description = this.retrieveClassInfoListSectionData['description'];
  ...
  async handleClassInfoListPageChange(): Promise<void>
  {
  ...
  async fetchClassInfoList() {
    ...
    let searchResponse = <RetrieveListResponseModel>await this.backendService.retrieveClassInfoList(this.searchFilter);
  ...
  {
    this.executeUserActionCustom(actionName, 'RetrieveClassInfoList', this.router, dataObject, this.backendService, this.toastNotificationService);
  }
  ...
  {
    this.updateDependentFieldsDisplayProps(apiName, key,  selectedValue, this, ["retrieveClassInfoListSC"]);
  }
