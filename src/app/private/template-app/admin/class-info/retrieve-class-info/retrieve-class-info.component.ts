...
export class RetrieveClassInfoComponent
  ...
  implements OnInit
{
  ...
  async ngOnInit(): Promise<void> {
    ...
    if (
      !(this.selectedClassInfoUUID && this.selectedClassInfoUUID.length > 0)
    ) {
      return;
    }
    ...
    //Load page fields
    let retrieveClassInfoResponseParamList =
      await this.getApiResponseParameterListCustom(
        "retrieveClassInfo",
        this.backendService,
        this.toastNotificationService
      );
    this.retrieveClassInfoFieldList =
      this.getRetrievePageSectionFieldListCustom(
        "retrieveClassInfo",
        "RetrieveClassInfo",
        retrieveClassInfoResponseParamList,
  ...
  executeUserAction(actionName: any) {
    this.executeUserActionCustom(actionName, "RetrieveClassInfo", this.router, {
      id: this.selectedClassInfoUUID,
    });
  }
