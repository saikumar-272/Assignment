...
export class RetrieveCountryComponent  extends FormFieldsTemplateAppImplComponent implements OnInit
{
  ...
  retrieveCountryFieldList : Array<any> = [];
  ...
  sectionsShowHideInfo = {
    enableRetrieveCountrySection : true
  }
  lineItemsSectionsShowHideInfo = {
  }
  
  additionalProperties: any = {};
  pageSectionNameList : any[] = ["retrieveCountry"];
  ...
  async ngOnInit(): Promise<void>
  {
      ...
      this.additionalProperties = await this.getAdditionalPropertiesOnLoad("retrieveCountry", this.toastNotificationService, this.backendService, this.retrievedDataObject);
      this.userActions = this.getUserActionsCustom('RetrieveCountry');

      //Load page fields
      let retrieveCountryResponseParamList = await this.getApiResponseParameterListCustom('retrieveCountry', this.backendService, this.toastNotificationService);
      this.retrieveCountryFieldList = this.getRetrievePageSectionFieldListCustom('retrieveCountry', "RetrieveCountry", retrieveCountryResponseParamList, this.additionalProperties);
      this.doAfterPageDataLoaded("retrieveCountry", this.currentRoute, this, this.retrievedDataObject);
      ...
      this.modifyData("retrieveCountry", this.retrievedDataObject, this.additionalProperties, this.toastNotificationService, this.backendService);
  ...
  {
    this.executeUserActionCustom(actionName, 'RetrieveCountry', this.router, {"id" : this.selectedCountryUUID});
  }
