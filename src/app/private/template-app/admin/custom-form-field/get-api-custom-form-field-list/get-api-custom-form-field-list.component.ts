...
import {
    getApiCustomFormFieldListDataObject,
    getApiCustomFormFieldListSearchFilter
} from 'src/app/shared/interfaces/dto/template-app/custom-form-field/get-api-custom-form-field-list';
...
@Component({
selector: 'app-get-api-custom-form-field-list',
  templateUrl: './get-api-custom-form-field-list.component.html',
  styleUrls: ['./get-api-custom-form-field-list.component.scss']
...
export class GetApiCustomFormFieldListComponent extends FormFieldsTemplateAppImplComponent implements OnInit
{
  pageComponentReference: any;
  userActions : Array<any> = [];
  getApiCustomFormFieldListSectionFields: any = [];
  getApiCustomFormFieldListSectionData: any = {};
  getApiCustomFormFieldListSelectOptionsData: any = {};
  ...
  noOfPages: number = 0;
  searchFilter: getApiCustomFormFieldListSearchFilter = <getApiCustomFormFieldListSearchFilter>{};
  pageResultsMap: Map<number, getApiCustomFormFieldListDataObject[]> = new Map<number, getApiCustomFormFieldListDataObject[]>();
  pageSizeOptions = PAGE_SIZE_OPTIONS;
  

  
  yesNoOptions = YES_NO_OPTIONS;
  getApiCustomFormFieldListTableColumns : Array<any> = [];
  ...
  async ngOnInit(): Promise<void> {
    ...
    this.userActions = this.getUserActionsCustom('GetApiCustomFormFieldList');
    /**
    ...
    //Load table columns
    let getApiCustomFormFieldListResponseParamList = await this.getApiResponseParameterListCustom('getApiCustomFormFieldList', this.backendService, this.toastNotificationService);
    this.getApiCustomFormFieldListTableColumns = this.getListApiTableColumnListCustom('getApiCustomFormFieldList', getApiCustomFormFieldListResponseParamList, this);
    //Load page fields
    let getApiCustomFormFieldListRequestParamList = await this.getApiRequestParameterListCustom('getApiCustomFormFieldList', this.backendService, this.toastNotificationService);
    this.getApiCustomFormFieldListSectionFields = this.getSectionFieldsFromApiRequestParams('getApiCustomFormFieldList', getApiCustomFormFieldListRequestParamList, this);

    this.setDataToFormOnload("getApiCustomFormFieldList", this.router, this.currentRoute, this);
    this.onPageInit("getApiCustomFormFieldList", this.currentRoute, this, ["getApiCustomFormFieldListSC"]);
  }

  async resetSearchCriteria() {
    this.getApiCustomFormFieldListSectionData = {};
  }
  ...
  async search() {
    ...
    this.fetchCustomFormFieldList();
  }

  populateSearchFilterFromForm()
  {
    this.pageResultsMap.clear();
    this.searchFilter.apiName = this.getApiCustomFormFieldListSectionData['apiName'];
  ...
  async handleCustomFormFieldListPageChange(): Promise<void>
  {
  ...
  async fetchCustomFormFieldList() {
    ...
    let searchResponse = <RetrieveListResponseModel>await this.backendService.getApiCustomFormFieldList(this.searchFilter);
  ...
  {
    this.executeUserActionCustom(actionName, 'GetApiCustomFormFieldList', this.router, dataObject, this.backendService, this.toastNotificationService);
  }
  ...
  {
    this.updateDependentFieldsDisplayProps(apiName, key,  selectedValue, this, ["getApiCustomFormFieldListSC"]);
  }
