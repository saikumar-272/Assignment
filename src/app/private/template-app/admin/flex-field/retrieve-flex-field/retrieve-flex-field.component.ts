...
@Component({
selector: 'app-retrieve-flex-field',
  templateUrl: './retrieve-flex-field.component.html',
  styleUrls: ['./retrieve-flex-field.component.scss']
, imports: [CommonModule, RouterModule, DynamicFieldDisplayComponent, NgbModule, FormsModule, ReactiveFormsModule],
  standalone: true
})
export class RetrieveFlexFieldComponent  extends FormFieldsTemplateAppImplComponent implements OnInit
{
  pageComponentReference: any;
  pageHeading: any = 'Flex Field'
  userActions : Array<any> = [];
  retrieveFlexFieldFieldList : Array<any> = [];
  ...
  sectionsShowHideInfo = {
    enableRetrieveFlexFieldSection : true
  }
  lineItemsSectionsShowHideInfo = {
  }
  
  additionalProperties: any = {};
  pageSectionNameList : any[] = ["retrieveFlexField"];
  ...
  async ngOnInit(): Promise<void>
  {
      ...
      this.additionalProperties = await this.getAdditionalPropertiesOnLoad("retrieveFlexField", this.toastNotificationService, this.backendService, this.retrievedDataObject);
      this.userActions = this.getUserActionsCustom('RetrieveFlexField');

      //Load page fields
      let retrieveFlexFieldResponseParamList = await this.getApiResponseParameterListCustom('retrieveFlexField', this.backendService, this.toastNotificationService);
      this.retrieveFlexFieldFieldList = this.getRetrievePageSectionFieldListCustom('retrieveFlexField', "RetrieveFlexField", retrieveFlexFieldResponseParamList, this.additionalProperties);
      this.doAfterPageDataLoaded("retrieveFlexField", this.currentRoute, this, this.retrievedDataObject);
      ...
      this.modifyData("retrieveFlexField", this.retrievedDataObject, this.additionalProperties, this.toastNotificationService, this.backendService);
  ...
  {
    this.executeUserActionCustom(actionName, 'RetrieveFlexField', this.router, {"id" : this.selectedFlexFieldUUID});
  }
