...
import {
    retrievePrivilegeGroupListDataObject,
    retrievePrivilegeGroupListSearchFilter,
} from "src/app/shared/interfaces/dto/template-app/privilege-group/retrieve-privilege-group-list";
  ...
  implements OnInit
{
  ...
  retrievePrivilegeGroupListSectionFields: any = [];
  retrievePrivilegeGroupListSectionData: any = {};
  retrievePrivilegeGroupListSelectOptionsData: any = {};
  ...
  noOfPages: number = 0;
  searchFilter: retrievePrivilegeGroupListSearchFilter = <
    retrievePrivilegeGroupListSearchFilter
  >{};
  pageResultsMap: Map<number, retrievePrivilegeGroupListDataObject[]> = new Map<
    number,
    retrievePrivilegeGroupListDataObject[]
  >();
  ...
  retrievePrivilegeGroupListTableColumns: Array<any> = [];
  ...
  async ngOnInit(): Promise<void> {
    ...
    this.userActions = this.getUserActionsCustom("RetrievePrivilegeGroupList");
    /**
     * <ngb-pagination> component (pageChange) event is fired onload, so need not trigger search() explicitly here.
     */

    //Load table columns
    let retrievePrivilegeGroupListResponseParamList =
      await this.getApiResponseParameterListCustom(
        "retrievePrivilegeGroupList",
        this.backendService,
        this.toastNotificationService
      );
    this.retrievePrivilegeGroupListTableColumns =
      this.getListApiTableColumnListCustom(
        "retrievePrivilegeGroupList",
        retrievePrivilegeGroupListResponseParamList,
        this
      );
    //Load page fields
    let retrievePrivilegeGroupListRequestParamList =
      await this.getApiRequestParameterListCustom(
        "retrievePrivilegeGroupList",
        this.backendService,
        this.toastNotificationService
      );
    this.retrievePrivilegeGroupListSectionFields =
      this.getSectionFieldsFromApiRequestParams(
        "retrievePrivilegeGroupList",
        retrievePrivilegeGroupListRequestParamList,
        this
      );
  ...
  async resetSearchCriteria() {
    this.retrievePrivilegeGroupListSectionData = {};
  }
  ...
  async search() {
    ...
    this.fetchPrivilegeGroupList();
  }

  populateSearchFilterFromForm() {
    this.pageResultsMap.clear();
    this.searchFilter.name = this.retrievePrivilegeGroupListSectionData["name"];
    this.searchFilter.description =
      this.retrievePrivilegeGroupListSectionData["description"];
  ...
  async handlePrivilegeGroupListPageChange(): Promise<void> {
  ...
  async fetchPrivilegeGroupList() {
    ...
    let searchResponse = <RetrieveListResponseModel>(
      await this.backendService.retrievePrivilegeGroupList(this.searchFilter)
    );
