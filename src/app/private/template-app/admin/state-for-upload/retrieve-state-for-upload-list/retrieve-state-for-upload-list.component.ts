...
selector: "app-retrieve-state-for-upload-list",
  imports: [CommonModule, AdminChildSectionFormComponent, DynamicFieldDisplayComponent, RouterModule, FormsModule, NgbModule, NgbPaginationModule, ReactiveFormsModule],
