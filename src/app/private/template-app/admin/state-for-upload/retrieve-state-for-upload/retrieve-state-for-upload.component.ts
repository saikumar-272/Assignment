...
@Component({
selector: "app-retrieve-state-for-upload",
  templateUrl: "./retrieve-state-for-upload.component.html",
  styleUrls: ["./retrieve-state-for-upload.component.scss"],
  imports: [DynamicFieldDisplayComponent, BrowserAnimationsModule, CommonModule, RouterModule, NgbModule],
  standalone: true
})
export class RetrieveStateForUploadComponent
  ...
  implements OnInit
{
  ...
  retrieveStateForUploadFieldList: Array<any> = [];
  ...
  sectionsShowHideInfo = {
    enableRetrieveStateForUploadSection: true,
  };
  lineItemsSectionsShowHideInfo = {};

  additionalProperties: any = {};
  pageSectionNameList: any[] = ["retrieveStateForUpload"];
  constructor(
  ...
  async ngOnInit(): Promise<void> {
    ...
    this.retrievedDataObject = await this.backendService.retrieveStateForUpload(
      this.selectedStateForUploadUUID
    );
    if (
    ...
    this.additionalProperties = await this.getAdditionalPropertiesOnLoad(
      "retrieveStateForUpload",
      this.toastNotificationService,
      this.backendService,
      this.retrievedDataObject
    );
    this.userActions = this.getUserActionsCustom("RetrieveStateForUpload");

    //Load page fields
    let retrieveStateForUploadResponseParamList =
      await this.getApiResponseParameterListCustom(
        "retrieveStateForUpload",
        this.backendService,
        this.toastNotificationService
      );
    this.retrieveStateForUploadFieldList =
      this.getRetrievePageSectionFieldListCustom(
        "retrieveStateForUpload",
        "RetrieveStateForUpload",
        retrieveStateForUploadResponseParamList,
  ...
  executeUserAction(actionName: any) {
    this.executeUserActionCustom(
      ...
      "RetrieveStateForUpload",
      this.router,
      { id: this.selectedStateForUploadUUID }
    );
  }
