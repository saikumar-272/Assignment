...
selector: "app-create-student",
  imports: [CommonModule, AdminChildSectionFormComponent, RetrieveEmpLocationListSearchPopupComponent, RetrieveFacultyListSearchPopupComponent, RouterModule, NgbModule],
