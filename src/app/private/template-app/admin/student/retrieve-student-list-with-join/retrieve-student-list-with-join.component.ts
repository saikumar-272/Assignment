...
import {
    retrieveStudentListWithJoinDataObject,
    retrieveStudentListWithJoinSearchFilter,
} from "src/app/shared/interfaces/dto/template-app/student/retrieve-student-list-with-join";
...
@Component({
selector: "app-retrieve-student-list-with-join",
  imports: [CommonModule, AdminChildSectionFormComponent, DynamicFieldDisplayComponent, NgbModule, NgbPaginationModule],
  templateUrl: "./retrieve-student-list-with-join.component.html",
  styleUrls: ["./retrieve-student-list-with-join.component.scss"],
  standalone: true
})
export class RetrieveStudentListWithJoinComponent
  extends FormFieldsTemplateAppImplComponent
  implements OnInit
{
  pageComponentReference: any;
  userActions: Array<any> = [];
  retrieveStudentListWithJoinSectionFields: any = [];
  retrieveStudentListWithJoinSectionData: any = {};
  retrieveStudentListWithJoinSelectOptionsData: any = {};
  ...
  noOfPages: number = 0;
  searchFilter: retrieveStudentListWithJoinSearchFilter = <
    retrieveStudentListWithJoinSearchFilter
  >{};
  pageResultsMap: Map<number, retrieveStudentListWithJoinDataObject[]> =
    new Map<number, retrieveStudentListWithJoinDataObject[]>();
  pageSizeOptions = PAGE_SIZE_OPTIONS;

  yesNoOptions = YES_NO_OPTIONS;
  retrieveStudentListWithJoinTableColumns: Array<any> = [];
  ...
  async ngOnInit(): Promise<void> {
    ...
    this.userActions = this.getUserActionsCustom("RetrieveStudentListWithJoin");
    /**
     * <ngb-pagination> component (pageChange) event is fired onload, so need not trigger search() explicitly here.
     */

    //Load table columns
    let retrieveStudentListWithJoinResponseParamList =
      await this.getApiResponseParameterListCustom(
        "retrieveStudentListWithJoin",
        this.backendService,
        this.toastNotificationService
      );
    this.retrieveStudentListWithJoinTableColumns =
      this.getListApiTableColumnListCustom(
        "retrieveStudentListWithJoin",
        retrieveStudentListWithJoinResponseParamList,
        this
      );
    //Load page fields
    let retrieveStudentListWithJoinRequestParamList =
      await this.getApiRequestParameterListCustom(
        "retrieveStudentListWithJoin",
        this.backendService,
        this.toastNotificationService
      );
    this.retrieveStudentListWithJoinSectionFields =
      this.getSectionFieldsFromApiRequestParams(
        "retrieveStudentListWithJoin",
        retrieveStudentListWithJoinRequestParamList,
        this
      );
  ...
  async resetSearchCriteria() {
    this.retrieveStudentListWithJoinSectionData = {};
  }
  ...
  populateSearchFilterFromForm() {
    ...
    this.searchFilter.firstName =
      this.retrieveStudentListWithJoinSectionData["firstName"];
    this.searchFilter.lastName =
      this.retrieveStudentListWithJoinSectionData["lastName"];
  ...
  async fetchStudentList() {
    ...
    let searchResponse = <RetrieveListResponseModel>(
      await this.backendService.retrieveStudentListWithJoin(this.searchFilter)
    );
