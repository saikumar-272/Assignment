...
export class RetrieveTaxTypeComponent
  extends FormFieldsTemplateAppImplComponent
  implements OnInit
{
  pageComponentReference: any;
  pageHeading: any = "Tax Type";
  userActions: Array<any> = [];
  retrieveTaxTypeFieldList: Array<any> = [];
  ...
  sectionsShowHideInfo = {
    enableRetrieveTaxTypeSection: true,
  };
  lineItemsSectionsShowHideInfo = {};

  additionalProperties: any = {};
  pageSectionNameList: any[] = ["retrieveTaxType"];
  constructor(
  ...
  async ngOnInit(): Promise<void> {
    ...
    this.userActions = this.getUserActionsCustom("RetrieveTaxType");

    //Load page fields
    let retrieveTaxTypeResponseParamList =
      await this.getApiResponseParameterListCustom(
        "retrieveTaxType",
        this.backendService,
        this.toastNotificationService
      );
    this.retrieveTaxTypeFieldList = this.getRetrievePageSectionFieldListCustom(
      "retrieveTaxType",
      "RetrieveTaxType",
      retrieveTaxTypeResponseParamList,
  ...
  executeUserAction(actionName: any) {
    this.executeUserActionCustom(actionName, "RetrieveTaxType", this.router, {
      id: this.selectedTaxTypeUUID,
    });
  }
